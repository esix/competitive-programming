...
can't contain them in any ordinary data types 
like a long integer.
...
Output two lines. The first line should 
contain `a+b`, and the second line should 
contain `a×b`. Don't print any leading zeros.
